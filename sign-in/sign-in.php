<?php 
    ...
    if(isset($_POST['signInSubmit'])){
        ...
        echo "<script>                    
                window.location.replace('http://localhost/lab1_nmantt/home-page/home-page.html') ;
                window.parent.location.replace('http://localhost/lab1_nmantt/home-page/home-page.html');
            </script>";
        $connect->close();
        die();
    }
